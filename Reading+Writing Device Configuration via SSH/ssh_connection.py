import paramiko # non default module that will perform the SSH operations on each of the devices
import os.path
import time
import sys
import re
...
user_file = input("\n# Enter user file path and name (e.g. D:\PR_lab2\file.txt): ")

# Verifying the validity of the USERNAME/PASSOWRD file
...
cmd_file = input("\n# Enter commands file path and name (e.g. D:\PR_lab2\file.txt): ")
